...
urlpatterns = [
    ...
    path('rashibhavishya/', views.rashibhavishya_index, name='rashibhavishya_index'),
    path('rashibhavishya/<str:rashi_name>/', views.rashibhavishya_detail, name='rashibhavishya_detail'),
